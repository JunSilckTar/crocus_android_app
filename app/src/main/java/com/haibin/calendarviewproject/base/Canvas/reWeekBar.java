 ...
 * 自定义英文栏
 */
public class reWeekBar extends WeekBar {

    private int mPreSelectedIndex;
    private ActionBarDrawerToggle.Delegate mDelegate;

    public reWeekBar(Context context) {
        super(context);
        LayoutInflater.from(context).inflate(R.layout.canvas_week_bar, this, true);
        setBackgroundColor(this.getResources().getColor(R.color.colormain));
